...
administrador.getPracticantesBySemestre = async(idSemestre) => {
    return await db.query('select idPracticante, nombre, foto, hora, carrera, mencion from practicante, registro where idPracticante = practicante.id and idSemestre = ? group by nombre', [idSemestre])
}
